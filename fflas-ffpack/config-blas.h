...
extern "C" {
	...
	static void cblas_dcopy(const int N, const double *X, const int incX, double *Y, const int incY)
	{
		dcopy_(&N,X,&incX,Y,&incY);
	}


	static void cblas_scopy(const int N, const float *X, const int incX, float *Y, const int incY)
	{
		scopy_(&N,X,&incX,Y,&incY);
	}

	static void cblas_dscal(const int N, const double alpha,  double *Y, const int incY)
	{
		dscal_(&N,&alpha,Y,&incY);
	}

	static void cblas_sscal(const int N, const float alpha,  float *Y, const int incY)
	{
...
extern "C" {
	...
	static inline CBLAS_INT clapack_dgetrf(const blas_enum CBLAS_ORDER, const CBLAS_INT M, const CBLAS_INT N,
	...
	static inline CBLAS_INT clapack_dgetri(const blas_enum CBLAS_ORDER, const CBLAS_INT N, double *A,
	...
	static inline CBLAS_INT clapack_dtrtri(const blas_enum CBLAS_ORDER Order,const blas_enum CBLAS_UPLO Uplo,
